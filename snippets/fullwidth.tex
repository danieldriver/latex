...
% Add table support as pandoc renders (in longtable environments)
% Unfortunately this is basically not supported in floatrow, but see this:
% http://tex.stackexchange.com/questions/96008/longtable-captions-in-marginpar

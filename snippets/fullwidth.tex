...
\usepackage{floatrow,caption}% make use of full width with tables and figures

\DeclareMarginSet{outside}{\setfloatmargins*{}{\hskip-\overhang}}
\DeclareFloatSeparators{marginparsep}{\hskip\marginparsep}
\captionsetup[capbesidefigure]{labelsep=newline,labelfont={bf},justification=raggedright}
\floatsetup[figure]{margins=outside,floatwidth=\textwidth,%
  capposition=beside,capbesideposition={top,outside},facing=yes,%

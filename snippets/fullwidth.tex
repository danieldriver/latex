...
% The caption + mcaption packages seem the easiest way to stylize captions
% and put them in the marginpar space (floatrow feels unwieldy). Since longtable
% is unresponsive to nearly all notes > margins solutions, I'll leave it out for now.
...
% However, I've been unable to port it to the `caption` redefinition of \LT@makecaption

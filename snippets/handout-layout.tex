...
\usepackage{marginfix}% ``fix'' margins and put a header over the first margin
\AtBeginDocument{\marginpar{\centering\T\large ((notes\char"0020\&\char"0020 ideas))}}

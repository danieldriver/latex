...
\newcommand\hands{\fontspec{Scala Sans Pro}\LARGE}
\newcommand{\aside}[1]{% \aside command
...
\newcommand{\hello}[1]{\marginpar[% introduce a person with \hello{name, date}
...
% tk -- move all of the following over to marginpar + boxes 
\newcommand{\nb}{\marginnote[% standard marginal pointer: \nb
  \hands\hfill\char"EA3D\kern-1.7pt]{%
  \hands\kern-1.5pt\char"EA3E}}%
\newcommand{\nbalt}{\marginnote[% pointer + reminder: \nbalt
  \hands\hfill\char"EA4D\kern-1.7pt]{%
  \hands\kern-1.5pt\char"EA4E}}%
\newcommand{\thebird}{\marginnote[% and for special use: \thebird
  \hands\hfill\char"EA11\kern-2.6pt]{%
  \hands\kern-2.4pt\char"EA11}}%

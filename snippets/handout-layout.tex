...
\newcommand\asc[1]{\scshape\MakeLowercase{#1}}% all small caps: \asc{}
\newcommand\prof{Daniel R. Driver}
\newcommand\course{RLGS 1013: Old Testament Scripture}
\newcommand\firstfoot{D.\,R. Driver, RLGS 1013}
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}\renewcommand{\headrulewidth}{0pt}% clear headers and footers
\fancyfoot[LE,RO]{\thepage}% define facing pages
\fancyfoot[RE]{\asc\prof}
\fancyfoot[LO]{\asc\course}
\fancypagestyle{plain}{% redefine the first page
  \fancyfoot[L]{\asc\firstfoot}
  \fancyfoot[R]{\thepage}}

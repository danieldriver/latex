...
It was first published in 1530 in Marburg, just six years before Tyndale was strangled and burnt at the stake for heresy back in England. Ironically, his translation the New Testament, and much of the Old, would become the largest single contribution to the officially approved King James Bible (1611). That version of the Bible's first sentence left a lasting mark on the English language. \textit{In the beginning God created the heaven and the earth.} Its standing, though, has quietly been challenged in a number of more recent translations.

Just when did God create? That is the question raised by these newer translations. The question has an ancient pedigree, too. \hello{Augustine of Hippo, 354--430}{\bfseries St. Augustine} pondered it often, and it turns up repeatedly in his works.
